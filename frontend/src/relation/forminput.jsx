...
export default class FormInput extends React.Component {
    render() {
        const {showModal, closeHandler, changeHandler, saveHandler, RelationModel, mode, errors,
        sureDeleteHandler, checkDuplic} = this.props
        return (
            <div>
        ...
        {mode === 'delete' ? <Modal.Title>Hapus Data</Modal.Title> : <div></div> }
                ...
                {mode === 'delete'?
                    <Modal.Body>
                        <div className="modal-body">
                            <p>Anda akan menghapus {RelationModel.name} ?</p>
                        </div>
                    </Modal.Body>
                    :
                <Modal.Body>
                    ...
                    <input type="text" id="name" name="name" value={RelationModel.name} onChange={changeHandler("name")} /><br />
                ...
                {mode === 'delete' ?
                <Modal.Footer>
                     <button type="button" classname="btn btn-default" onClick={() => sureDeleteHandler(RelationModel)} >Ya</button>
